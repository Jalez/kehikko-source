 ...
 * away. It is a bug that costs an afternoon and whose only symptom is a container
 * reporting a module that will not speak.
 *
 * It matters more in this module than in most: the greeting is not merely how
 * this page learns the theme, it carries the passage, which is the entire input
 * to the program. A missed greeting here is a container that says "nothing is
 * pointing at a file" while something is.
 *
